...
from s3prl.upstream.ivector.hubconf import *
from s3prl.upstream.I_hubert.hubconf import *
from s3prl.upstream.ee_hubert.hubconf import *
from s3prl.upstream.short_mel_hubert_masked_prediction.hubconf import *
